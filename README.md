...
<b>Used tools?</b>
- Python 3.8
  - Statistical techniques for descriptve analysis, implementation of various ML algorithms through cross validation with ROC-AUC metrics for 'buy_decision' prediction and R2 Score for 'price' prediction
- Pycharm Community
- Streamlit
- Heroku
